...
contract Gravedigger is IERC721Receiver, ReentrancyGuard, Ownable {
  ...
  address private nfTombstoneContractAddress = 0xd9145CCE52D386f254917e481eB44e9943F39138; //testnet contract
  ...
  constructor() Ownable() {
    ...
    function changeActiveTombstone(uint _newTombstone) public {
        ...
        require(msg.sender == tombstoneNFT.ownerOf(_newTombstone), "That's not your tombstone!");
