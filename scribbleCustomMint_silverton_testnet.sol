...
//Scribble Warlock Customs minting contract by The Spot on Avax. 
//Thespot.art <- The Spot on Avax
...
contract ScribbleCustoms is ERC721URIStorage, IERC721Receiver, ReentrancyGuard, Ownable {
  ...
  address public treasuryWallet; //for royalties
  ...
  function royaltyInfo(uint256, uint256 value) external view returns(address, uint256) {
        return (treasuryWallet, value * 5000 / 10000); //5% royalties
    } 
