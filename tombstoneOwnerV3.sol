...
interface ITombstone {
    ...
    function engraveTombstone(uint _tokenID, string memory newTokenUri) external;
    function addHasBeenEngraved(uint _id) external;
...
contract Gravedigger is Ownable {
  ...
  address private nfTombstoneContractAddress = 0x9a2E12340354d2532b4247da3704D2A5d73Bd189; //testnet contract
  ...
  constructor() Ownable() {
    ...
    function setNfTombstoneAddress(address _treasuryWallet)
        external
        onlyOwner
    {
        nfTombstoneContractAddress = _treasuryWallet;
    }
