...
contract JPEG is ERC20 {
    ...
    constructor(uint256 _initialSupply, uint256 _treasuryAllocation, uint256 _emissionRate, uint256 _weeklyReduction, uint256 _maxClaimAmount, uint256 _claimInterval) ERC20("JPEGANON", "JPEGANON") {
